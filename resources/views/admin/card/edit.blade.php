    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Chỉnh sửa thẻ</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                            <form id="cardForm">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary" id="btnEdit">Thêm mới</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('scripts')
<script>
    const CARD_ID = @json($card_id);
</script>
<script src="{{asset('common/js/upload-file.js')}}"></script>
<script src="{{assetAdmin('js/pages/card/edit.js')}}"></script>
@endsection